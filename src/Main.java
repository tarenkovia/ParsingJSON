...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        bankClientsMas[0] = new BankClient(0, new PassData("Иван", "Иванов", "Иванович",
                ...
                new ArrayList<>(Arrays.asList(new Bills("147852369854758", new Date(2020, 4, 13), new Date(2020, 4, 13)))),
                new ArrayList<>(Arrays.asList(new BankCard("Иван", "Иванов", new Date(2020, 4, 13),
